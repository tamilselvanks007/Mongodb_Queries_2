...
db.topics
  .find({
    $and: [
      ...
      { topic_date: { $lte: new Date("31-10-2020") } },
    ],
  })
  .pretty();
...
db.tasks
  .find({
    $and: [
      { due_date: { $gte: new Date("01-10-2020") } },
      { due_date: { $lte: new Date("31-10-2020") } },
    ],
  })
  .pretty();
...
db.users
  .aggregate([
    ...
    { $group: { _id: "$mentor_id", mentor_count: { $count: {} } } },
